...
public class EngineData {
     ...
     *
     * @param dataType the ERSAP data-type for the user-data
    ...
    static {
        DataUtil.EngineDataAccessor.setDefault(new Accessor());
    }

    private static class Accessor extends DataUtil.EngineDataAccessor {
