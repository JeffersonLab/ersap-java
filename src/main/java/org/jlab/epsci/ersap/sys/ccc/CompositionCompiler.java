...
/**
 * ERSAP compiler. Compiles the application logical description, i.e.
...
public class CompositionCompiler {
     ...
     */
    public static final String SERV_NAME = ErsapComponent.SERVICE_NAME_REGEX;
    ...
    public void compile(String iCode) throws ErsapException {
        ...
        // ERSAP ; end of statement operator
        ...
        if (instructions.isEmpty()) {
            throw new ErsapException("Composition is irrelevant for a service.");
        }

    }

    /**
     * Tokenize code by ERSAP end of statement operator ";".
     *
     ...
     */
    private Set<String> preProcess(String pCode) throws ErsapException {
        if (!pCode.contains(";") && !pCode.endsWith(";")) {
            throw new ErsapException("Syntax error in the ERSAP routing program. "
    ...
    private boolean parseStatement(String iStmt) throws ErsapException {
        boolean b = false;
    ...
    private boolean parseConditionalStatement(String iStmt, Instruction ti) throws ErsapException {
        boolean b = false;
    ...
    private Instruction parseCondition(String iCnd) throws ErsapException {
        Instruction ti;
