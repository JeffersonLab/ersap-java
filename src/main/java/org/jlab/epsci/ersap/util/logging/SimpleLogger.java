...
import org.jlab.epsci.ersap.util.logging.OutputChoice.OutputChoiceType;
...
public class SimpleLogger implements Logger {
    ...
    static void init() {
        ...
        if (DATE_TIME_FORMAT_STR != null) {
            try {
                ...
                // nocheck: LineLength
                Util.report("Bad date format in "
                    + CONFIGURATION_FILE
    ...
    /**
     * Package access allows only {@link SimpleLogger} to instantiate
