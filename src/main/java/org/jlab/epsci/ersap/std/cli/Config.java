...
/**
 * Environment configuration for a ERSAP shell session.
 */
public class Config {
    ...
    /**
     * The variable for the session of the ERSAP DPE.
     */
...
//                .withInitialValue(FileUtils.ersapPath("data", "input").toString())
...
//                .withInitialValue(FileUtils.ersapPath("data", "output").toString())
            .withInitialValue(FileUtils.userDataPath().toString()
                + File.separator + "data"
...
//                .withInitialValue(FileUtils.ersapPath("log").toString())
                .withInitialValue(FileUtils.userDataPath().toString()
                    + File.separator + "log")
                .withParser(ConfigParsers::toDirectory)
                .withCompleter(fileCompleter());
    ...
    void setenv(String name, String value) {
        ...
        if (name.equals("ERSAP_HOME")) {
            throw new IllegalArgumentException("cannot override $ERSAP_HOME variable");
        }
